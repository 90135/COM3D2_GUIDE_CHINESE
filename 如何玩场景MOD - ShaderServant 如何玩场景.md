...
如果你使用 CMI（目前版本 2.6.4.1），那么你只需要安装 DanceCameraMotion 和 PartEdit 和插件汉化，推荐为 ShaderServant 补充着色器 [安装教程](https://90135.gitbook.io/com3d2_simple_mod_guide_chinese/fu-lu/shaderservant-he-materialeditor-de-an-zhuang)
